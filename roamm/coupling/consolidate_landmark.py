#!/usr/bin/env python3
"""Consolidate the landmark: additive slowing vs multiplicative decoupling.
...
(OUT/"landmark_summary.json").write_text(json.dumps(summary,indent=2)+"\n")
print("\nwrote landmark_summary.json")
