...
within 8\%. The centroparietal response to contextual surprisal could not be tested usefully
...
Each item was localised to its answer-bearing sentences using sentence embeddings and
...
Analyses were run in Python with NumPy, SciPy, pandas and scikit-learn. Analysis code and the
derived tables needed to reproduce every figure are available at [repository]. The primary
dataset is openly available \citep{roammdata} and the control dataset is distributed by its
authors \citep{hollenstein2018}.
